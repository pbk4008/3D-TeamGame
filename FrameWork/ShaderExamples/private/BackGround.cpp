...
HRESULT CBackGround::NativeConstruct_Prototype()
{
	...
	if (FAILED(SetUp_Components((_uint)SCENEID::SCENE_STATIC, L"Proto_Component_Texture", L"BackGroundTex", (CComponent**)&m_pTexture)))
		return E_FAIL;

	if (FAILED(SetUp_Components((_uint)SCENEID::SCENE_STATIC, L"Proto_Component_RectBuffer", L"BackGroundBuffer", (CComponent**)&m_pRcTex)))
		return E_FAIL;
