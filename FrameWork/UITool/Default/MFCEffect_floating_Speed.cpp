...
CMFCEffect_Floating_Speed::CMFCEffect_Floating_Speed()
{
}

CMFCEffect_Floating_Speed::CMFCEffect_Floating_Speed(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
    :CEffect(pDevice,pDeviceContext)
{
}

CMFCEffect_Floating_Speed::CMFCEffect_Floating_Speed(const CEffect& rhs)
    :CEffect(rhs)
{
}

HRESULT CMFCEffect_Floating_Speed::NativeConstruct_Prototype()
{
...
HRESULT CMFCEffect_Floating_Speed::NativeConstruct(const _uint iSceneID, void* pArg)
{
...
_int CMFCEffect_Floating_Speed::Tick(_double TimeDelta)
{
	_matrix mat, mat1;
...
_int CMFCEffect_Floating_Speed::LateTick(_double TimeDelta)
{
...
HRESULT CMFCEffect_Floating_Speed::Render()
{
...
HRESULT CMFCEffect_Floating_Speed::SetUp_Components()
{
	...
	if (FAILED(__super::SetUp_Components(TOOL_LEVEL::TOOL_LEVEL_LOGO, L"Prototype_Component_VIBuffer_PointInstance_Floating_Speed", L"Com_VIBuffer", (CComponent**)&m_pBuffer, &Desc)))
		return E_FAIL;

	return S_OK;
}

CEffect* CMFCEffect_Floating_Speed::Copy()
{
	return nullptr;
}

CMFCEffect_Floating_Speed* CMFCEffect_Floating_Speed::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	/* 원형객체 생성할때 초기화 */
	CMFCEffect_Floating_Speed* pInstance = new CMFCEffect_Floating_Speed(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Creating CMFCEffect_Floating_Speed");
...
CGameObject* CMFCEffect_Floating_Speed::Clone(const _uint iSceneID, void* pArg)
{
	/* 복제본 생성할때는 아래함수 호출해서 추가 초기화를 진행 */
	CMFCEffect_Floating_Speed* pInstance = new CMFCEffect_Floating_Speed(*this);
	if (FAILED(pInstance->NativeConstruct(iSceneID ,pArg)))
	{
		MSGBOX("Failed to Creating Clone CMFCEffect_Floating_Speed");
		Safe_Release(pInstance);
	}
...
void CMFCEffect_Floating_Speed::Free()
{
	__super::Free();
}
