...
HRESULT CPostProcess::PossProcessing(CTonemapping* tone,CTarget_Manager* pTargetMgr, _bool hdr, _bool shadow)
{
	...
	if (FAILED(tone->Blend_FinalPass(pTargetMgr, hdr, shadow))) return E_FAIL;
