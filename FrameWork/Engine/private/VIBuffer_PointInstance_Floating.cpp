#include "..\public\VIBuffer_PointInstance_Floating.h"
#include <time.h>

CVIBuffer_PointInstance_Floating::CVIBuffer_PointInstance_Floating(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CVIBuffer(pDevice, pDeviceContext)
{

}

CVIBuffer_PointInstance_Floating::CVIBuffer_PointInstance_Floating(const CVIBuffer_PointInstance_Floating & rhs)
	: CVIBuffer(rhs)
...
HRESULT CVIBuffer_PointInstance_Floating::NativeConstruct_Prototype(/*const _tchar* pShaderFilePath, _uint iNumInstance*/)
{
...
HRESULT CVIBuffer_PointInstance_Floating::NativeConstruct(void * pArg)
{
...
HRESULT CVIBuffer_PointInstance_Floating::Render(_uint iPassIndex)
{
...
void CVIBuffer_PointInstance_Floating::Update(_double TimeDelta, _uint eAxis)
{
	if ((_uint)AXIS::AXIS_END <= eAxis)
	{
		MSGBOX("Failed to Update In CVIBuffer_PointInstance_Floating::Update");
		return;
	}
...
void CVIBuffer_PointInstance_Floating::Particle_Setting_RandomPos()
{
	for (_uint i = 0; i < m_Desc.iNumInstance; ++i)
	{
...
void CVIBuffer_PointInstance_Floating::Particle_Reset()
{
	m_bSettingDir = false;
	m_fGravityTime = 0.f;
...
CVIBuffer_PointInstance_Floating * CVIBuffer_PointInstance_Floating::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext/*, const _tchar* pShaderFilePath, _uint iNumInstance*/)
{
	CVIBuffer_PointInstance_Floating*		pInstance = new CVIBuffer_PointInstance_Floating(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype(/*pShaderFilePath, iNumInstance*/)))
	{
		MSGBOX("Failed to Creating CVIBuffer_PointInstance_Floating");
...
CComponent * CVIBuffer_PointInstance_Floating::Clone(void * pArg)
{
	CVIBuffer_PointInstance_Floating*		pInstance = new CVIBuffer_PointInstance_Floating(*this);
