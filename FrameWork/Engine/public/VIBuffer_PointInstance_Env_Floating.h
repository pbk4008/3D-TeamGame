...
class ENGINE_DLL CVIBuffer_PointInstance_Env_Floating final : public CVIBuffer
{
...
protected:
	explicit CVIBuffer_PointInstance_Env_Floating(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CVIBuffer_PointInstance_Env_Floating(const CVIBuffer_PointInstance_Env_Floating& rhs);
	virtual ~CVIBuffer_PointInstance_Env_Floating() = default;
public:
...
private:
	...
	_float m_fAutoResetTimeAcc = 0.f;
public:
	static CVIBuffer_PointInstance_Env_Floating* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext/*, const _tchar* pShaderFilePath, _uint iNumInstance*/);
