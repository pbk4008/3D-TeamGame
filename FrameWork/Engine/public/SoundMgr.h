...
friend CSingleTon;
public:
	enum  CHANNELID { BGM, PLAYER1, PLAYER2, PLAYER3, MONSTER, EFFECT, UI, BATTLE, 
		Player_Sword_Attack, GUIDE, FootStep1, FootStep2,
		Power_Resonance_01,
		...
		Sword2H_Hit, Sword2H_Death, Sword2H_Attack, 
		Shooter_Hit, Shooter_Death, Shooter_Attack_1, Shooter_Attack_2,
		Healer_Hit, Healer_Death, Healer_Attack, Healer_Reinforce,
