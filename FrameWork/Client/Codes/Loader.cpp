...
HRESULT CLoader::SetUp_Stage1_Prototype()
{
	...
	if(FAILED(g_pGameInstance->Add_Prototype((_uint)SCENEID::SCENE_STATIC,L"Proto_Component_Rect_Buffer_Potal", CVIBuffer_Rect::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
