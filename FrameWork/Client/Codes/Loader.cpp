...
#pragma region 모델
	...
	if (FAILED(g_pGameInstance->Add_Texture(m_pDevice, L"DistortionMask", L"../bin/Resources/Texture/Trail/T_StreakDistortion_M.dds"))) MSGBOX("Failed To Add SwordTrail Tex");
	// 2
