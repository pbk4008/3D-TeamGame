...
CUI_Skill_Meter_Gauge_Right::CUI_Skill_Meter_Gauge_Right(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	:CUI(pDevice,pDeviceContext)
{
}

CUI_Skill_Meter_Gauge_Right::CUI_Skill_Meter_Gauge_Right(const CUI& rhs)
	: CUI(rhs)
{
}

HRESULT CUI_Skill_Meter_Gauge_Right::NativeConstruct_Prototype()
{
...
HRESULT CUI_Skill_Meter_Gauge_Right::NativeConstruct(const _uint _iSceneID, void* pArg)
{
	if (nullptr != pArg)
	{
...
_int CUI_Skill_Meter_Gauge_Right::Tick(_double TimeDelta)
{
	if (FAILED(__super::Tick(TimeDelta)))
		return -1;


	m_fRatio = (g_pObserver->Get_Player()->Get_SkillGuage() - 50.f) / 50.f;
...
_int CUI_Skill_Meter_Gauge_Right::LateTick(_double TimeDelta)
{
...
HRESULT CUI_Skill_Meter_Gauge_Right::Render()
{
...
HRESULT CUI_Skill_Meter_Gauge_Right::SetUp_Components()
{
...
CUI_Skill_Meter_Gauge_Right* CUI_Skill_Meter_Gauge_Right::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	/* 원형객체 생성할때 초기화 */
	CUI_Skill_Meter_Gauge_Right* pInstance = new CUI_Skill_Meter_Gauge_Right(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Creating CUI_Skill_Meter_Gauge_Right");
...
CGameObject* CUI_Skill_Meter_Gauge_Right::Clone(const _uint _iSceneID, void* pArg)
{
	CUI_Skill_Meter_Gauge_Right* pInstance = new CUI_Skill_Meter_Gauge_Right(*this);
	if (FAILED(pInstance->NativeConstruct(_iSceneID, pArg)))
	{
		MSGBOX("Failed to Creating Clone CUI_Skill_Meter_Gauge_Right");
		Safe_Release(pInstance);
	}
...
void CUI_Skill_Meter_Gauge_Right::Free()
{
	__super::Free();
}
