...
CSilvermane_KnockBackBwd::CSilvermane_KnockBackBwd(ID3D11Device* _pDevice, ID3D11DeviceContext* _pDeviceContext)
	: CSilvermane_Hit(_pDevice, _pDeviceContext)
{
}

HRESULT CSilvermane_KnockBackBwd::NativeConstruct(void* _pArg)
{
...
_int CSilvermane_KnockBackBwd::Tick(const _double& _dDeltaTime)
{
...
_int CSilvermane_KnockBackBwd::LateTick(const _double& _dDeltaTime)
{
...
HRESULT CSilvermane_KnockBackBwd::Render()
{
...
HRESULT CSilvermane_KnockBackBwd::EnterState()
{
...
HRESULT CSilvermane_KnockBackBwd::ExitState()
{
...
_int CSilvermane_KnockBackBwd::Input(const _double& _dDeltaTime)
{
...
CSilvermane_KnockBackBwd* CSilvermane_KnockBackBwd::Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pDeviceContext, void* _pArg)
{
	CSilvermane_KnockBackBwd* pInstance = new CSilvermane_KnockBackBwd(_pDevice, _pDeviceContext);
	if (FAILED(pInstance->NativeConstruct(_pArg)))
	{
		MSGBOX("CSilvermane_KnockBackBwd Create Fail");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CSilvermane_KnockBackBwd::Free()
{
	__super::Free();
}
