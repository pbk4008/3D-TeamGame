...
_int C2H_HammerJogFwdPivot180::Tick(const _double& _dDeltaTime)
{
	...
	if (15 < m_pAnimationController->Get_CurKeyFrameIndex())
...
_int C2H_HammerJogFwdPivot180::Input(const _double& _dDeltaTime)
{
	...
	{
		if (35 < m_pAnimationController->Get_CurKeyFrameIndex())
		{
