...
PS_OUT PS_MAIN(PS_IN In)
{
	...
	half metal = g_MetalicTex.Sample(DefaultSampler, In.vUvDepth.xy).r;
	half roughness = g_RoughnessTex.Sample(DefaultSampler, In.vUvDepth.xy).r;
	half ao = g_AOTex.Sample(DefaultSampler, In.vUvDepth.xy).r;
