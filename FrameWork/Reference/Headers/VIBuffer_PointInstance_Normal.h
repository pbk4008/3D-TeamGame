...
class ENGINE_DLL CVIBuffer_PointInstance_Normal final : public CVIBuffer
{
...
protected:
	explicit CVIBuffer_PointInstance_Normal(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CVIBuffer_PointInstance_Normal(const CVIBuffer_PointInstance_Normal& rhs);
	virtual ~CVIBuffer_PointInstance_Normal() = default;
public:
...
public:
	static CVIBuffer_PointInstance_Normal* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext/*, const _tchar* pShaderFilePath, _uint iNumInstance*/);
