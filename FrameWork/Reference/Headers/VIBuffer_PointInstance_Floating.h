...
class ENGINE_DLL CVIBuffer_PointInstance_Floating final : public CVIBuffer
{
...
protected:
	explicit CVIBuffer_PointInstance_Floating(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CVIBuffer_PointInstance_Floating(const CVIBuffer_PointInstance_Floating& rhs);
	virtual ~CVIBuffer_PointInstance_Floating() = default;
public:
...
public:
	static CVIBuffer_PointInstance_Floating* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext/*, const _tchar* pShaderFilePath, _uint iNumInstance*/);
