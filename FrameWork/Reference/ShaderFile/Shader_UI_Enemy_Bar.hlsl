...
//서서히 사라져야하고 기본텍스쳐에 다른 컬러가 입혀져서 작동해야할때 사용
//주로 몬스터에 사용되고 있음
...
PS_OUT PS_MAIN_REDWHITE(PS_IN In)
{
    ...
    if (1.f != g_fX)
    {
        ...
        {
            if (In.vTexUV.x > (g_fX - g_fCurAttack)) //제일앞쪽부터 뒤에는 계속 하얗게 렌더
            {
                Out.vColor.rgb = 1.f;
            }
        }
        ...
        if (In.vTexUV.x > (g_fX - 0.02f) && In.vTexUV.x < g_fX) //오른쪽하얀라인ㄴ
        {
            Out.vColor.rgb = 1.f;
        }
        ...
        {
            if (In.vTexUV.x > 0.f && In.vTexUV.x < 0.02f) //왼쪽하얀라인
            {
                Out.vColor.rgb = 1.f;
            }
        }
        ...
        {
            if (In.vTexUV.x > (g_fX - g_fCurAttack) && In.vTexUV.x < (g_fX - g_fCurAttack + 0.02f)) //왼쪽하얀라인
            {
                Out.vColor.rgb = 1.f;
            }
        }
